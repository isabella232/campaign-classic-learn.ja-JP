...
+ メッセージの送信{#sending-messages}
   + メールチャネル{#email-channel}
      ...
      + [E メール配信コンテンツのデザイン](/help/sending-messages/email-channel/design-email-delivery-content.md)
   ...
   + メッセージの監視 {#monitoring-messages}
      + [強制隔離管理について](/help/sending-messages/quarantine-management.md)
...
+ ワークフローを使用した自動化{#automating-with-workflows}
   ...
   + [タイムゾーンの管理](/help/automating-with-workflows/manage-time-zones.md)
   ...
   + [スケジューラーアクティビティの設定](/help/automating-with-workflows/configure-scheduler-activities.md)
...
+ ランディングページの設定 {#landing-pages}
   + [ランディングページの設定](/help/designing-content/configure-landingpages.md)
   + [環境設定センターの作成](/help/designing-content/create-a-preference-center.md)
+ [調査の作成](/help/designing-content/create-a-survey.md)
+ 監視 {#monitoring}
